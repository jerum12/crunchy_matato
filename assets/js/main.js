jQuery(
  (function ($) {
    ...
    // // Buy Now Btn
    // $('body').append("<a href='https://themeforest.net/checkout/84396698/create_account?_ga=2.95336604.1430237439.1644119533-1297998632.1635997908' target='_blank' class='buy-now-btn'>Buy Now</a>");
...
function toggleTheme() {
  if (localStorage.getItem('cm_theme') === 'theme-dark') {
